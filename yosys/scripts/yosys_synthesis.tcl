...
# HyperBus block - preserve hierarchy for SDC and area reporting
yosys setattr -set keep_hierarchy 1 "t:hyperbus_synchronous$*"
yosys setattr -set keep_hierarchy 1 "t:hyperbus_frontend$*"
yosys setattr -set keep_hierarchy 1 "t:hyperbus_axi$*"
yosys setattr -set keep_hierarchy 1 "t:hyperbus_backend$*"
yosys setattr -set keep_hierarchy 1 "t:hyperbus_cfg_regs$*"
yosys setattr -set keep_hierarchy 1 "t:hyperbus_phy_if$*"
yosys setattr -set keep_hierarchy 1 "t:hyperbus_phy$*"
yosys setattr -set keep_hierarchy 1 "t:hyperbus_trx$*"
yosys setattr -set keep_hierarchy 1 "t:hyperbus_tx_clk_delay$*"
