...
set ROOT "/scratch/vlsi2_24fs26/reference_flow_rom"
...
if {[catch { vlog -incr -sv \
    ...
    "$ROOT/rtl/neopixel/neopixel_reg.sv" \
    "$ROOT/rtl/neopixel/write_to_fifo.sv" \
    "$ROOT/rtl/neopixel/neopixel_dma.sv" \
    "$ROOT/rtl/neopixel/neopixel_controller.sv" \
    "$ROOT/rtl/neopixel/neopixel.sv" \
