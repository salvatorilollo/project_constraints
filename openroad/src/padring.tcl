...
place_pad -row IO_EAST  -location [expr {$eastStart + 10*$eastPitch}] "pad_hyper_rwds_io"    ; # pin no: 11
place_pad -row IO_EAST  -location [expr {$eastStart +  9*$eastPitch}] "pad_neopixel_data_o"    ; # pin no: 10
...
place_pad -row IO_NORTH -location [expr {$northStart -  2*$northPitch}] "pad_hyper_dq_0_io"       ; # pin no:  3
place_pad -row IO_NORTH -location [expr {$northStart -  3*$northPitch}] "pad_hyper_dq_1_io"       ; # pin no:  4
place_pad -row IO_NORTH -location [expr {$northStart -  4*$northPitch}] "pad_hyper_dq_2_io"       ; # pin no:  5
place_pad -row IO_NORTH -location [expr {$northStart -  5*$northPitch}] "pad_hyper_dq_3_io"       ; # pin no:  6
place_pad -row IO_NORTH -location [expr {$northStart -  6*$northPitch}] "pad_hyper_dq_4_io"       ; # pin no:  7
place_pad -row IO_NORTH -location [expr {$northStart -  7*$northPitch}] "pad_hyper_dq_5_io"       ; # pin no:  8
place_pad -row IO_NORTH -location [expr {$northStart -  8*$northPitch}] "pad_hyper_dq_6_io"       ; # pin no:  9
place_pad -row IO_NORTH -location [expr {$northStart -  9*$northPitch}] "pad_hyper_dq_7_io"       ; # pin no: 10
place_pad -row IO_NORTH -location [expr {$northStart - 10*$northPitch}] "pad_hyper_reset_no"       ; # pin no: 11
place_pad -row IO_NORTH -location [expr {$northStart - 11*$northPitch}] "pad_hyper_cs_no"       ; # pin no: 12
place_pad -row IO_NORTH -location [expr {$northStart - 12*$northPitch}] "pad_hyper_ck_o"       ; # pin no: 13
place_pad -row IO_NORTH -location [expr {$northStart - 13*$northPitch}] "pad_hyper_ck_no"       ; # pin no: 14
