...
module croc_chip import croc_pkg::*; #() (
  ...
  inout wire VSSIO
    ...
    localparam int unsigned GpioCount = 19; //adjusted to make space for Hyperbus
    ...
    // Hyperbus
    logic                  soc_hyper_reset_no;
    logic                  soc_hyper_cs_no;
    logic                  soc_hyper_ck_o;
    logic                  soc_hyper_ck_no;
    logic                  soc_hyper_rwds_o;
    logic                  soc_hyper_rwds_i;
    logic                  soc_hyper_rwds_oe_o;
    logic [7:0]            soc_hyper_dq_o;
    logic [7:0]            soc_hyper_dq_i;
    logic                  soc_hyper_dq_oe_o;
    ...
    //HYPERBUS PADS
    sg13cmos5l_IOPadInOut30mA pad_hyper_reset_no    (.pad(hyper_reset_no), .c2p(soc_hyper_reset_no), .p2c(),  .c2p_en(1'b1));
    sg13cmos5l_IOPadInOut30mA pad_hyper_cs_no   (.pad(hyper_cs_no), .c2p(soc_hyper_cs_no), .p2c(),  .c2p_en(1'b1));
    sg13cmos5l_IOPadInOut30mA pad_hyper_ck_o      (.pad(hyper_ck_o),    .c2p(soc_hyper_ck_o), .p2c(),  .c2p_en(1'b1));
    sg13cmos5l_IOPadInOut30mA pad_hyper_ck_no     (.pad(hyper_ck_no),   .c2p(soc_hyper_ck_no), .p2c(),  .c2p_en(1'b1));
    sg13cmos5l_IOPadInOut30mA pad_hyper_rwds_io   (.pad(hyper_rwds_io), .c2p(soc_hyper_rwds_o), .p2c(soc_hyper_rwds_i),  .c2p_en(soc_hyper_rwds_oe_o));
    sg13cmos5l_IOPadInOut30mA pad_hyper_dq_0_io   (.pad(hyper_dq_0_io), .c2p(soc_hyper_dq_o[0]), .p2c(soc_hyper_dq_i[0]),  .c2p_en(soc_hyper_dq_oe_o));
    sg13cmos5l_IOPadInOut30mA pad_hyper_dq_1_io   (.pad(hyper_dq_1_io), .c2p(soc_hyper_dq_o[1]), .p2c(soc_hyper_dq_i[1]),  .c2p_en(soc_hyper_dq_oe_o));
    sg13cmos5l_IOPadInOut30mA pad_hyper_dq_2_io   (.pad(hyper_dq_2_io), .c2p(soc_hyper_dq_o[2]), .p2c(soc_hyper_dq_i[2]),  .c2p_en(soc_hyper_dq_oe_o));
    sg13cmos5l_IOPadInOut30mA pad_hyper_dq_3_io   (.pad(hyper_dq_3_io), .c2p(soc_hyper_dq_o[3]), .p2c(soc_hyper_dq_i[3]),  .c2p_en(soc_hyper_dq_oe_o));
    sg13cmos5l_IOPadInOut30mA pad_hyper_dq_4_io   (.pad(hyper_dq_4_io), .c2p(soc_hyper_dq_o[4]), .p2c(soc_hyper_dq_i[4]),  .c2p_en(soc_hyper_dq_oe_o));
    sg13cmos5l_IOPadInOut30mA pad_hyper_dq_5_io   (.pad(hyper_dq_5_io), .c2p(soc_hyper_dq_o[5]), .p2c(soc_hyper_dq_i[5]),  .c2p_en(soc_hyper_dq_oe_o));
    sg13cmos5l_IOPadInOut30mA pad_hyper_dq_6_io   (.pad(hyper_dq_6_io), .c2p(soc_hyper_dq_o[6]), .p2c(soc_hyper_dq_i[6]),  .c2p_en(soc_hyper_dq_oe_o));
